...
if __name__ == '__main__':
    ...
    corr_matrix(data, save = 1, name ='(2)corr_matrix.pdf')
    #Visualize relationship between grade and loan status
    sorted_grade = sorted(data['grade'].unique())
    countpl(column = 'grade', data = data, hue= 'loan_status', save = 1, \
    ...
    barpl(grade_co, grade_fp, save = 1, name = '(4)grade_bar.pdf')
    #Visualize relationship between subgrade and loan status
    sorted_sub_grade = sorted(data['sub_grade'].unique())
    countpl(column = 'sub_grade', data = data, hue= 'loan_status', save = 1, \
    ...
    barpl(sub_grade_co, sub_grade_fp, save = 1, name = '(6)sub_grade_bar.pdf')
    ...
    countpl(column = 'verification_status' , data = data, hue='loan_status', save = 1, \
    ...
    barpl(verification_status_co, verification_status_fp, save = 1,\
    ...
    histpl(column = 'int_rate', data = data, save = 1, \
    ...
    countpl(column = 'emp_length', data = data, hue= 'loan_status', save = 1, \
